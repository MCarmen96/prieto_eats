...
<div class="container py-5">
    ...
    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="row g-4">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                  placeholder="Detalla los ingredientes y características del plato..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ReposDAW2\prieto_eats\resources\views/admin/products/create.blade.php ENDPATH**/ ?>